...
enum ReloadOnError {
  /// Keep every page that reloaded and leave the rest as they were. Best-effort, the default. A
  /// stale page beside fresh neighbours can seam: `itemId` de-dups the duplicates, gaps heal on the
  /// next refresh.
  commitSucceeded,
