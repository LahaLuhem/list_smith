...
/// A platform-adaptive error surface carrying the error and a retry action. [isCompact] switches between
/// the full-viewport first-page form and the new-page footer.
